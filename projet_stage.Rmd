...
## **Add metadata (cell.type) to the pool object**
```{r}
...
#load("~/Université/BIOLOGIE/Master Bioinformatique/M1 Bioinformatique/Semestre 2/Stage M1/Projet/code/test.RData")
```
