...
#Create SingleCellExperiment objet usinng pool seurat object 
pool.sce <- as.SingleCellExperiment(pool)
pool.sce@colData
head(pool.sce$seurat_clusters)

#Find all markers for pool2
Idents(pool) <- "seurat_clusters"
pool_markers <- FindAllMarkers(pool, only.pos = TRUE) 
#write_xlsx(pool2_markers, "~/Documents/projet_stage/data/pool2_markers.xlsx")
load("/home/rose/Documents/projet_stage/data/cellasign/pool2_markers.RData")
