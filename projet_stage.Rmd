...
list_pool2_markers <- lapply(split(pool2_markers[-1], pool2_markers[[1]]), function(x) unlist(x, use.names=FALSE))
print(str(list_pool2_markers))  

#Creation of the marker gene matrix
matrix <- marker_list_to_mat(list_pool2_markers, include_other = FALSE)
print(str(matrix))
```
