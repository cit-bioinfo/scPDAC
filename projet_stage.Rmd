...
```{r}
experiment.merged <- RenameIdents(object = pool.init, '30'= '0', '31'= '0', '26'= '0', '6' = '1', '8' = '1', '9'= '2', '20'= '2', '25'= '2', '24'= '2', '25'= '2', '18'= '2', '14'= '2', '13'= '3', '29'= '3', '27'= '4', '34'= '4', '12'= '4', '5'= '4', '33'= '4', '32'= '4', '17'='22', '11'='10', '15'='10', '21'='10', '16'='19', '28'='19')
...
new.cluster.ids <- c("Stellate cell", "Ductall cell 1", "Ductall cell 2", "Macrophage", "Endothelial cell", "Acinar cell", "Fibroblast", "T cell", "B cell", "Endocrine cell")
names(new.cluster.ids) <- levels(experiment.merged)
pool.init <- RenameIdents(experiment.merged, new.cluster.ids)

DimPlot(pool.init, reduction = "umap", pt.size = 0.5, repel=TRUE, label= TRUE) + NoLegend()
...
write.table(pool@meta.data, file="~/Documents/projet_stage/data/analysis/metadata_pool_object.tsv", sep="\t", row.names=T, col.names=T, quote=F)

write.table(pool@active.ident, file="~/Documents/projet_stage/data/analysis/active_ident_pool_object.tsv", sep="\t", row.names=T, col.names=T, quote=F)
```
