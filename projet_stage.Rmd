...
###### Data import
```{r}
load("/home/rose/Documents/projet_stage/data/cellasign.RData")

#SingleCellExperiment object
## Converting the Seurat object to a SingleCellExperiment object
Idents(pool2) <- "cluster"
pool2_sce <- as.SingleCellExperiment(pool2)
print(pool2_sce)
print(head(pool2_sce$cluster))

## Create SingleCellExperiment object by counts matrix
counts2 <- data.matrix(counts, rownames.force = NA)
metadata2 <- data.matrix(metadata, rownames.force = NA)
sce <- SingleCellExperiment(list(counts=counts2), colData=DataFrame(metadata2))
sce
print(head(sce$cluster))
