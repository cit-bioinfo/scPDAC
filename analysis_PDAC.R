...
load("~/Documents/projet_stage/data/analysis/metadata_pool_object.RData")
...
#write.table(metadata_pool_object, file="~/Documents/projet_stage/data/analysis/pool_metadata_object.tsv", sep="\t", row.names=F, col.names=T, quote=F)
